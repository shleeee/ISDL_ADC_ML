...
#
#plt.figure(1)
#plt.hexbin(time_array, vol_array, bins='log', vmax=2.1)
...
plt.hexbin(time_array, vol_array, vmax=400)
plt.title('data DFE equalized EYE diagram')
plt.xlabel('time[ps]')
plt.ylabel('p2p voltage[mV]')
cb = plt.colorbar()
cb.set_label('log10(N)')
plt.savefig('eye_diagram_dfe_data_lin.png')
...
plt.figure(2)
#plt.hexbin(time_array, vol_array, bins='log', vmax=2.5)
plt.hexbin(time_array, vol_array, vmax=270)
plt.title('edge DFE equalized EYE diagram')
plt.xlabel('time[ps]')
plt.ylabel('p2p voltage[mV]')
cb = plt.colorbar()
cb.set_label('log10(N)')
plt.savefig('eye_diagram_dfe_edge_lin.png')
