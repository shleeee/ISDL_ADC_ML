module channel_34dB(input var real x, output var real y);
...
`timescale 1ns/1fs
	...
	real ac_r1 = 0;
	real ac_i1 = 0;
	parameter real gain_r1 = 0.0047909890;
	parameter real gain_i1 = 0.0014690913;
	parameter real  exp_r1 = 0.9790041605;
	parameter real  exp_i1 = 0.0312729763;
	real ac_r2 = 0;
	real ac_i2 = 0;
	parameter real gain_r2 = 0.0047909890;
	parameter real gain_i2 = -0.0014690913;
	parameter real  exp_r2 = 0.9790041605;
	parameter real  exp_i2 = -0.0312729763;
	real ac_r3 = 0;
	real ac_i3 = 0;
	parameter real gain_r3 = -0.0249748947;
	parameter real gain_i3 = 0.0000000000;
	parameter real  exp_r3 = 0.9787391749;
	parameter real  exp_i3 = 0.0000000000;
	real ac_r4 = 0;
	real ac_i4 = 0;
	parameter real gain_r4 = 0.0005468902;
	parameter real gain_i4 = 0.0000000000;
	parameter real  exp_r4 = 0.9985302612;
	parameter real  exp_i4 = 0.0000000000;
	real ac_r5 = 0;
	real ac_i5 = 0;
	parameter real gain_r5 = 0.0141920376;
	parameter real gain_i5 = 0.0000000000;
	parameter real  exp_r5 = 0.9913766722;
