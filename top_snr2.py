...
X_test1=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_1dB2.txt",1,5) # 5x800000
X_test2=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_2dB2.txt",1,5) # 5x800000
X_test3=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_3dB2.txt",1,5) # 5x800000
X_test4=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_4dB2.txt",1,5) # 5x800000
X_test5=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_5dB2.txt",1,5) # 5x800000
X_test6=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_6dB2.txt",1,5) # 5x800000
X_test7=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_7dB2.txt",1,5) # 5x800000
X_test8=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_8dB2.txt",1,5) # 5x800000
X_test9=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_9dB2.txt",1,5) # 5x800000
X_test10=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_10dB2.txt",1,5) # 5x800000
X_test11=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_11dB2.txt",1,5) # 5x800000
X_test12=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_12dB2.txt",1,5) # 5x800000
X_test13=ios.load_input("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_out_13dB2.txt",1,5) # 5x800000
Y_test1, y_test1 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_1dB2.txt",2) # 2x800000
Y_test2, y_test2 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_2dB2.txt",2) # 2x800000
Y_test3, y_test3 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_3dB2.txt",2) # 2x800000
Y_test4, y_test4 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_4dB2.txt",2) # 2x800000
Y_test5, y_test5 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_5dB2.txt",2) # 2x800000
Y_test6, y_test6 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_6dB2.txt",2) # 2x800000
Y_test7, y_test7 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_7dB2.txt",2) # 2x800000
Y_test8, y_test8 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_8dB2.txt",2) # 2x800000
Y_test9, y_test9 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_9dB2.txt",2) # 2x800000
Y_test10, y_test10 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_10dB2.txt",2) # 2x800000
Y_test11, y_test11 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_11dB2.txt",2) # 2x800000
Y_test12, y_test12 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_12dB2.txt",2) # 2x800000
Y_test13, y_test13 = ios.load_output("./data/PAM4_real/w_AGC/17dB/SNR/prbs7/data_in_13dB2.txt",2) # 2x800000
